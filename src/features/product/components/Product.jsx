...
import { useProductStore } from "../../users/store/productStore"; // <-- Asegúrate de que esta ruta sea correcta para tu proyecto
...
// 2. AHORA SÍ: El componente se llama "Products" (con S al final)
export const Products = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "2rem", fontFamily: "'DM Sans', sans-serif", backgroundColor: "#FAFAFA" }}>
      <style>{FONTS}</style>
      
      {/* LEYENDA (Legend) */}
      <div className="flex gap-6 mb-4 items-center text-sm font-medium text-gray-700">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="bg-[#111827] text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-800 transition shadow-sm"
        >
          + Agregar Producto
        </button>
      </div>
      ...
      {/* TABLA ESTILO EXCEL */}
      {!loading && (
        <div className="bg-[#FAF9F6] border border-gray-200 rounded-xl overflow-x-auto shadow-sm">
                ...
                return (
                  <tr key={prod._id} className="border-b border-gray-100 hover:bg-white transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <span className="px-3 py-1 rounded-md font-semibold text-sm" style={{ backgroundColor: qtyStyle.bg, color: qtyStyle.text }}>
                        {prod.cantidad || 0}
                      </span>
                    </td>
                    ...
                    <td className="py-4 px-6">
                      <span className="px-3 py-1 rounded-md font-semibold text-sm" style={{ backgroundColor: expStyle.bg, color: expStyle.text }}>
                    ...
                    <td className="py-4 px-6 text-right space-x-2">
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-transparent border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
                      >
                      ...
                      <button
                        onClick={() => showConfirmToast({
                          ...
                          onConfirm: () => deleteProduct(prod._id), // 5. Usamos deleteProduct
                        })}
                        className="inline-flex items-center justify-center p-2 bg-transparent border border-gray-300 rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors"
                      >
